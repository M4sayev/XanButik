...
export const ourServices = [
  {
    ...
    description:
      "Experience a personalized styling consultation with our fashion experts, who will curate signature looks tailored to your individual taste and lifestyle, elevating your wardrobe.",
    img: personal_consultation_service,
  },
  {
    name: "Tailoring and Alteration",
    description:
      "Discover our precise tailoring and alteration services, ensuring your clothing fits impeccably, reflecting your unique style and enhancing your confidence.",
    img: tailoring_n_alteration,
  },
  {
    name: "Premium Suit Fittings",
    description:
      "Indulge in premium suit fittings, where our skilled professionals will guide you through selecting the perfect suit, exuding sophistication and refinement for every occasion.",
    img: premium_fitting,
  },
  {
    name: "Shoe Care and Repair",
    description:
      "Trust our specialized shoe care and repair services to keep your footwear in pristine condition, preserving their quality and extending their longevity.",
...
export const askedQuestions = [
  {
    id: 1000,
    question:
      "How can I find the right size when shopping for men's clothing online?",
