  ...
  return (
    <section className="featured-items">
      <div className="featured-items-content">
        <div
          ref={titleRef}
          className={`featured-items-title ${handleAnimation(titleInView)}`}
        >
        ...
        <div className="featured-items-imgs-grid">
          {favoriteItems.map((item, index) => {
            ...
            return (
              <FeaturedItem key={index} {...item} layoutClass={layoutClass} />
            );
          })}
        </div>
        <div
          className={`featured-items-btn-wrapper ${handleAnimation(btnInView)}`}
          ref={btnRef}
        >
          <Button
            id="ViewMore"
